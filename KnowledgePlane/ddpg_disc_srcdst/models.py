...
class Critic:
    ...
    def getModel(self):
        ...
        state_out = layers.Dense(200, activation="relu")(state_input)
...
class Actor:
    ...
    def getModel(self):
        ...
        last_init = tf.keras.initializers.RandomUniform(minval=0.4, maxval=0.6, seed=None)

        inputs = layers.Input(shape=(self.num_state,))
        out = layers.Dense(200, activation="relu")(inputs)
